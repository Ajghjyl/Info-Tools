<?php $__env->startSection('content'); ?>
    <div class="container">
        <div class="card mt-3">
            <div class="card-body">
                <div class="d-flex">
                    <h1>Create Contact Details <small class="text-muted"><?php echo e($prospect->name); ?></small></h1>
                    <div class="ml-auto">
                        <div class="dropdown">
        ...
        <div class="card mt-3">
            <div class="card-body">
                <form action="<?php echo e(route('admin.prospects.contacts.store', $prospect->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Info-Tools\resources\views/admin/prospects/contacts/create.blade.php ENDPATH**/ ?>